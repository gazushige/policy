    ...
    return (
      <div className="m-1 p-1">
        <main className="container m-1 text-gray-900 bg-white p-1">
            ...
            <h2>第3条（利用目的の変更）</h2>
            <span className=""><ol className="p-1 list-disc">
              <li>
            ...
            <br />
            <p>本ポリシーにつきまして、ご不明な点がございましたら<a className="text-blue-500 hover:text-blue-400 hover-bg-gray-400" href="mailto:gazushige@gmail.com">管理者</a>へお問い合わせ下さい</p><br/>
          </main>
            </div>
    );
  }
